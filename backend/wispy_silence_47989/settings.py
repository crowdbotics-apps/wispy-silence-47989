"""
Django settings for wispy_silence_47989 project.
...
ROOT_URLCONF = 'wispy_silence_47989.urls'
...
WSGI_APPLICATION = 'wispy_silence_47989.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_silence_47989 API",
    "DESCRIPTION": "API documentation for wispy_silence_47989 App",
    "VERSION": "v1",
}
